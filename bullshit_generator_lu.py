...
======================================================================
 Bullshit Generator 
    ...
    Luxembourgized and Presentationized by @SteveClement, December 2014
======================================================================
'''
...
# Also, were Markov Chains usefull to anyone?
class Node(object):
    ...
    def getString(self):
        # python wot? 2.4 (Nov.20-2004) 2.5 (Sep.19-2006) 2.6 (Oct.01-2008) 2.7 (Jul.03-2010)
        # Thus came print() py-3.x 3.0 (Jun.27-2009) 3.1 (Feb.20-2011) 3.2 (Sep.29-2012) 3.3 3.4
...
verb = TerminalNode(
	"zougrëffer", "activéiert", "géréiert", "aggrégéiert", "baut"
	"rechend", ""
